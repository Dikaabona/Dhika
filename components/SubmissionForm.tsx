      ...
      <form onSubmit={handleSubmit} className="space-y-10">
        ...
        {status === 'Sakit' && (
          <div className="space-y-4 animate-in zoom-in-95 duration-300">
            ...
            <label htmlFor="doc-upload" className={`flex flex-col items-center justify-center p-12 border-2 border-dashed rounded-[32px] cursor-pointer transition-all ${docBase64 ? 'bg-emerald-50 border-emerald-300' : 'bg-slate-50 border-slate-200 hover:border-[#FFC000] hover:bg-slate-100/50'}`}>
