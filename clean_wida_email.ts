...
async function cleanWidaEmail() {
  const email = 'wida.oktapiani99@gmail.com';
  ...
  if (error) {
    console.log('Error cleaning email:', error.message);
  } else {
    console.log('Email cleaned successfully.');
  }
}
